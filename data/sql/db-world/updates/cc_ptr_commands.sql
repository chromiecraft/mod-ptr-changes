...
('bf',1,'Syntax: .bf $subcommand\nType .bf to see the list of possible subcommands or .help bf $subcommand to see info on subcommands.'),
('bf enable',1,'Syntax: .bf enable #battleid'),
('bf start',1,'Syntax: .bf start #battleid'),
('bf stop',1,'Syntax: .bf stop #battleid'),
('bf switch',1,'Syntax: .bf switch #battleid'),
('bf timer',1,'Syntax: .bf timer #battleid #timer\n#timer: use a timestring like \"1h15m30s\".'),
